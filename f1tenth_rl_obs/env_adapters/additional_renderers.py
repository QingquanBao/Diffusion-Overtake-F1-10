...
class TrackRenders:
    def __init__(self, waypoints, frenet_coord, width, color=[255, 255, 255], boundary_color=[255, 0, 0], point_size=4, render_mode='point'):
        import jax
        ...
        waypoints_boundary = jnp.concatenate([waypoints_render_subsample[:, 0:1], jax.vmap(frenet_coord.frenet_to_cartesian_jax)(jnp.concatenate([waypoints_render_subsample[:, 0:1], 
